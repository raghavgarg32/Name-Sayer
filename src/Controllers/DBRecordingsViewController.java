...
public class DBRecordingsViewController extends SideButtons {
    ...
    /**
     * Callback function called when the play button is clicked, the method will then play the selected database name.
     * If no item is selected an alert is shown instead
     * @throws IOException
     */
    @FXML
    ...
    /**
     * Changes scene to the recording stage of the application
     */
    @FXML
