...
public class RateViewController extends SideButtons implements Initializable {
	...
	public void handleBadButton() {
		...
		String selectionName = currentName;
			...
			BashCommandWorker creationDirectoryWorker = new BashCommandWorker("badRecordingMessage='"+ HomeViewController.getNamesHashMap().get(currentName)+"'\n" +
					"\n" +
	...
	public void handleGoodButton() {
		String selectionName = currentName;
			...
			BashCommandWorker creationDirectoryWorker = new BashCommandWorker("sed -i '/"+ HomeViewController.getNamesHashMap().get(currentName)+"/d' ./BadRecordingList.txt; \n" +
					"sed -i '/"+ HomeViewController.getNamesHashMap().get(currentName)+" recording for "+ selectionName+ " has a bad quality/d' ./Database/"+selectionName+"/Ratings.txt ;");
